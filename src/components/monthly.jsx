        ...
        <div className="container-fluid Moana">
            <div className="row">
                <div className={styles.suscribe}>
                    ...
                    <div className="col">
                        <form  action="https://app.us14.list-manage.com/subscribe/post?u=bf44b77a96eca4a9f0d57cc98&amp;id=95d43bddc6&amp;f_id=00d698e0f0" method="post">
                            <input type="email" className={styles.eemail} name= "EMAIL" class="required email" id="mce-EMAIL" placeholder="Ingresa tu correo electrónico" required/>
