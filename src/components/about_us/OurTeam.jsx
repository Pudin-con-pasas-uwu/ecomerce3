  const OurTeam = () => {
      return (
        ...
        <div className="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-4 justify-content-lg-center">
          <div className="col mb-4">
            <div className="card" id="TeamCard">
              <img className="CardImg Team1"/>
              <div className="card-body">
                <h5 className="card-title">Juan Realpozo</h5>
                <p className="card-text">Líder Front end</p>
              </div>
            </div>
          </div>
          <div className="col mb-4">
          ...
          <div className="col mb-4">
            <div className="card" id="TeamCard">
              <img className="CardImg Team7"/>
              <div className="card-body">
                <h5 className="card-title">Edgar Pérez</h5>
                <p className="card-text">Front end</p>
              </div>
            </div>
          </div>
